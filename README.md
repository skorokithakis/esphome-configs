...
- `bedtime.yaml`: ESP8266 D1 Mini with 240x240 ST7789V display, shows time/date/temperature/humidity/CO2 on synthwave background, subscribes to sensor data via MQTT, automatic brightness adjustment.
